  ...
  public class BbCodeProcessor
  {
    ...
    static BbCodeProcessor()
    {
      ...
      _formatters.Add(new RegexFormatter("\\[/quote(?:\\s*)\\]", "</p></div>"));
        _formatters.Add(new RegexFormatter("\\[table(?:\\s*)\\]", "<table>"));
        _formatters.Add(new RegexFormatter("\\[/table(?:\\s*)\\]", "</table>"));
        _formatters.Add(new RegexFormatter("\\[th(?:\\s*)\\]", "<th>"));
        _formatters.Add(new RegexFormatter("\\[/th(?:\\s*)\\]", "</th>"));
            _formatters.Add(new RegexFormatter("\\[tr(?:\\s*)\\]", "<tr>"));
        _formatters.Add(new RegexFormatter("\\[/tr(?:\\s*)\\]", "</tr>"));
            _formatters.Add(new RegexFormatter("\\[td(?:\\s*)\\]", "<td>"));
        _formatters.Add(new RegexFormatter("\\[/td(?:\\s*)\\]", "</td>"));
